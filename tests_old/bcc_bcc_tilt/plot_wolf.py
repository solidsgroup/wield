...
pylab.ylim(0,2)
if unrelaxed:
    pylab.plot(Tilt_112_Model[:,0],        1E-3*A_Mo*Tilt_112_Model[:,1],        color="blue", marker='', linestyle='-',label=legend('Mo (Model)').ljust(50))
    pylab.plot(Tilt_112_Model[:,0],        1E-3*A_Fe*Tilt_112_Model[:,1],        color="green",marker='', linestyle='-',label=legend('Fe (Model)').ljust(50))
else:
    pylab.plot(Tilt_112_Model[:,0],        1E-3*A_Mo*Tilt_112_Model[:,1],        color="blue", marker='', linestyle=':',label=legend('Mo (Unrelaxed model)').ljust(60))
    pylab.plot(Tilt_112_Model_Relaxed[:,0],1E-3*A_Mo*Tilt_112_Model_Relaxed[:,1],color="blue", marker='', linestyle='-',label=legend('Mo (Relaxed model)').ljust(50))
    pylab.plot(Tilt_112_Model[:,0],        1E-3*A_Fe*Tilt_112_Model[:,1],        color="green",marker='', linestyle=':',label=legend('Fe (Unrelaxed model)').ljust(60))
    pylab.plot(Tilt_112_Model_Relaxed[:,0],1E-3*A_Fe*Tilt_112_Model_Relaxed[:,1],color="green",marker='', linestyle='-',label=legend('Fe (Relaxed model)').ljust(60))
pylab.plot(Tilt_112_Wolf_Mo[:,0],      1E-3*     Tilt_112_Wolf_Mo[:,1],      color="blue", marker='o',linestyle='', label=legend('Mo (MD-FS)').ljust(50))
pylab.plot(Tilt_112_Wolf_Fe[:,0],      1E-3*     Tilt_112_Wolf_Fe[:,1],      color="green",marker='o',linestyle='', label=legend('Fe (MD-Johnson)').ljust(50))
if not args.labels_off:
