...
for theta in range(0,91,1):
    ...
    os.system("python3 ../../../scripts/plotPolarSurface.py outfiles/F2_"+str(theta).zfill(3)+".dat -o images/plot_"+str(theta).zfill(3)+".png -m cubic -r 300 300 -f facetfiles/F3_"+str(theta).zfill(3)+".dat -c")
