...
pylab.plot(Sigma_0_25[:,0], (Sigma_0_25[:,1] - min(Sigma_0_25[:,1]))/(max(Sigma_0_25[:,1])-min(Sigma_0_25[:,1])),color="black",linewidth=3,linestyle='-',label='$\sigma=0.25\alpha$')
...
pylab.plot(Sigma_0_15[:,0], (Sigma_0_15[:,1] - min(Sigma_0_15[:,1]))/(max(Sigma_0_15[:,1])-min(Sigma_0_15[:,1])),color="black",linewidth=2,linestyle=':',label='$\sigma=0.15\alpha$')
